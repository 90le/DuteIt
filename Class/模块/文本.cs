...
namespace DuteIT
{
    public static class 文本
    {
        ...
        /// <param name="leftStr">
        /// <param name="rightStr">
        /// <param name="ignoreCase">忽略大小写 则为true 默认区分大小写
        /// <returns></returns>
        ...
        /// <returns></returns>
        public static string[] RegMatchAll(string regStr, string text)
        {
            if (string.IsNullOrWhiteSpace(text))
                return null;
            bool isMatch = Regex.IsMatch(text, regStr);
            if (!isMatch)
                return null;
            MatchCollection matchCol = Regex.Matches(text, regStr, RegexOptions.ExplicitCapture);
        ...
        /// </summary>
        ///<param name="count">长度
        ///<param name="char_type">0=小写 1=大写 2=大小写混合
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="str">
        /// <param name="defaultResult">转换失败的默认值
        /// <returns></returns>
